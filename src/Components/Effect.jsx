...
export const Effect = () => {
    ...
    return (
        <>
            <div className={`absolute z-[-2] duration-300 pointer-events-none transition-all ${effect ? 'left-[25%] top-[38%] opacity-0' : 'left-[70%] top-[40%] opacity-100'}`}>
                <svg width="100" height={height} className={`transition-all duration-300 svg-val ${effect ? '' : 'blur-xl'}`} viewBox="0 0 195 370" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className={`absolute z-[-2] duration-300 pointer-events-none transition-all ${effect ? 'left-[25%] top-[38%] opacity-0' : 'left-0 top-10 opacity-100'}`}>
                <svg width="100" className={`transition-all duration-300 ${effect ? '' : 'blur-xl'}`} height={height} viewBox="0 0 183 358" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className={`absolute  z-[-2] duration-300 pointer-events-none transition-all ${effect ? 'left-[25%] top-[38%] opacity-0' : 'left-[30%] rotate-45 top-[30%] opacity-100'}`}>
            ...
            <div className={`absolute z-[-2] duration-300 pointer-events-none transition-all ${effect ? 'left-[25%] top-[38%] opacity-0' : 'left-[50%] rotate-45 top-0 opacity-100'}`}>
