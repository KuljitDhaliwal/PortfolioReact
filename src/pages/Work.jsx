        ...
        <div className={`${clicked ? '-translate-y-5 opacity-0' : 'translate-y-0 opacity-100' } ${theme ==="light" ? 'text-black' : 'text-white'} min-h-screen flex md:flex-row flex-col w-full justify-center items-center px-5`}>
            <div className="flex justify-center items-center w-full gap-5">
                <div ref={projectImageRef} className="project-image-sec md:flex hidden w-1/2 relative max-h-[300px] h-[300px]">
                    <img src="/project1.png" alt="" className="opacity-0 absolute img border-2 transition-all duration-300 border-red-500 shadow rounded cursor-pointer" id="project1"/>
                    <img src="/project2.png" alt="" className="opacity-0 absolute img border-2 transition-all duration-300 border-red-500 shadow rounded cursor-pointer" id="project2"/>
                </div>
