    ...
    return (
        <div className={`min-h-screen w-full max-w-6xl m-auto flex justify-center items-center transition-all duration-300 ${clicked ? '-translate-y-5 opacity-0' : 'translate-y-0 opacity-100' } ${theme === 'light' ? 'text-black' : 'text-white'}`}>
            <div className='w-full px-5 grid gap-6'>
                <div className='text-5xl orbitron group transition-all duration-300'>
                ...
                <div className='flex md:flex-row justify-between gap-5 flex-col'>
                    <div className="flex w-full items-start md:justify-start gap-6 justify-between">
                        <h2 className='font-bold text-2xl'>Mail</h2>
                        <a href="mailto:kuljitsingh9488@gmail.com" target='_blank' className={`flex items-center relative group transition-all duration-300 orbitron cursor-pointer`}>
                            <FaArrowDownLong className='-rotate-135'/>
                            <span className='text-[13px] md:text-[18px]'>kuljitsingh9488 <span className='scale-x-150 transition-all duration-300 inline-block'>@</span> gmail.com</span>
                    ...
                    <div className="flex w-full items-start md:justify-end gap-6 justify-between">
                        <h2 className='font-bold text-2xl'>Social Media</h2>
                        <div className='flex flex-col gap-4'>
                            <a href="https://github.com/KuljitDhaliwal" target='_blank' className={`flex items-center relative group orbitron transition-all duration-300 cursor-pointer`}>
                                <FaArrowDownLong className='-rotate-135'/>
                            ...
                            <a href="https://www.linkedin.com/in/kuljit-singh-dhaliwal-391b15210/" target='_blank' className={`flex items-center relative group orbitron transition-all duration-300 cursor-pointer`}>
                                <FaArrowDownLong className='-rotate-135'/> 
